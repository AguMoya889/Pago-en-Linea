document.addEventListener('DOMContentLoaded', () => {
    ...
    // ============= CONFIG API BACKEND ==============================
    // ===============================================================
    // URL base del backend (la misma que usas en auth-backend.js)
    ...
    if (currentPage === 'transfer.html') {
        ...
        if (form) {
            form.addEventListener('submit', async e => {   // ← ahora es async
                e.preventDefault();
                ...
                // ===================================================
                // 1) LLAMAR AL BACKEND PARA GUARDAR EN LA BASE DE DATOS
                // ===================================================
                ...
                try {
                    if (token) {
                        ...
                        if (!res.ok) {
                            console.error('Error backend transferencia:', data);
                            // No frenamos la app para el usuario, sólo lo dejamos en consola
                            // Si quieres, aquí puedes mostrar un Swal de advertencia.
                        }
                    } else {
                        console.warn('No hay token en sessionStorage, no se llamó al backend de transacciones.');
                    }
                } catch (err) {
                    console.error('Error de conexión con backend en /transactions/transfer:', err);
                }

                // ===================================================
                // 2) LÓGICA LOCAL (LO QUE YA TENÍAS)
                // ===================================================
